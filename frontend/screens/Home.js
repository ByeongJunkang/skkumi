...
export default function Home({ navigation, route }) {
	...
	return (
		...
		>
			...
			>
				{isMap ? <Text>맵 모드</Text> : <Text>핀 모드</Text>}
			...
			>
				{!isBoard ? (
					...
					>
						...
						/>
						<View
							style={{ width: "90%", marginTop: 30, marginBottom: 15 }}
						>
							<PlaceText style={{ marginBottom: 15 }}>
							편의 시설 정보
							</PlaceText>
							<Text>{fac}</Text>
						</View>
					...
					>
						...
						>
							<Text style={{ color: "white", fontSize: 40, marginTop: -5 }}>
								+
							</Text>
						</TouchableOpacity>
					</View>
